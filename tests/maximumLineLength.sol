...
contract EventDefinitionsAndEventEmitters {
    ...
    function() {
        LongAndLotsOfArgs(sender, recipient, publicKey, amount, options, longAttribute);
        emit LongAndLotsOfArgs(sender, recipient, publicKey, amount, options, longAttribute);
    }
}
