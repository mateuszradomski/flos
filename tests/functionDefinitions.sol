...
interface FunctionInterfaces {
    ...
    function manyReturns()
        returns (uint y1, uint y2, uint y3, uint y4, uint y5, uint y6, uint y7, uint y8, uint y9, uint y10);
    function someParamsSomeModifiers(uint x1, uint x2, uint x3) modifier1() modifier2 modifier3;
    function someParamsSomeReturns(uint x1, uint x2, uint x3) returns (uint y1, uint y2, uint y3);
    function someModifiersSomeReturns() modifier1 modifier2 modifier3 returns (uint y1, uint y2, uint y3);
    ...
    function manyParamsManyModifiers(
        ...
        uint x9,
        uint x10
    ) modifier1 modifier2 modifier3 modifier4 modifier5 modifier6 modifier7 modifier8 modifier9 modifier10;
    ...
    function modifierOrderCorrect03() external payable override modifier1 modifier2 returns (address);
    function modifierOrderCorrect04() internal virtual override modifier1 modifier2 returns (uint);
    function modifierOrderIncorrect01() public view virtual override modifier1 modifier2 returns (uint);
    function modifierOrderIncorrect02() external virtual override modifier1 modifier2 returns (uint);
    function modifierOrderIncorrect03() internal pure virtual modifier1 modifier2 returns (uint);
    function modifierOrderIncorrect04() external payable override modifier1 modifier2 returns (uint);
}
...
contract FunctionDefinitions {
    ...
    function manyParamsManyModifiers(
        ...
        uint x9,
        uint x10
    ) public modifier1 modifier2 modifier3 modifier4 modifier5 modifier6 modifier7 modifier8 modifier9 modifier10 {
        a = 1;
    }
    function manyParamsManyReturns(
        uint x1,
