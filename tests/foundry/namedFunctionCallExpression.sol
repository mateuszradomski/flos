...
contract NamedFunctionCallExpression {
    ...
    struct StructWithAVeryLongNameThatExceedsMaximumLengthThatIsAllowedForFormatting {
    ...
    function test() external {
        ...
        StructWithAVeryLongNameThatExceedsMaximumLengthThatIsAllowedForFormatting memory long =
            StructWithAVeryLongNameThatExceedsMaximumLengthThatIsAllowedForFormatting({ whyNameSoLong: "dunno" });
