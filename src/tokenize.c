...
tokenTypeToString(TokenType tokenType) {
    switch(tokenType) {
        ...
        case TokenType_Exclamation: return LIT_TO_STR("!");
        case TokenType_Plus: return LIT_TO_STR("+");
        case TokenType_Minus: return LIT_TO_STR("-");
        case TokenType_Percent: return LIT_TO_STR("%");
        case TokenType_Divide: return LIT_TO_STR("/");
        case TokenType_Star: return LIT_TO_STR("*");
        case TokenType_StarStar: return LIT_TO_STR("**");
        case TokenType_Ampersand: return LIT_TO_STR("&");
        case TokenType_Pipe: return LIT_TO_STR("|");
        case TokenType_Carrot: return LIT_TO_STR("^");
        case TokenType_LeftShift: return LIT_TO_STR("<<");
        case TokenType_RightShift: return LIT_TO_STR(">>");
        case TokenType_RightShiftZero: return LIT_TO_STR(">>>");
        case TokenType_Tylde: return LIT_TO_STR("~");
        case TokenType_PlusPlus: return LIT_TO_STR("++");
        case TokenType_MinusMinus: return LIT_TO_STR("--");
        case TokenType_QuestionMark: return LIT_TO_STR("?");
        case TokenType_LeftEqual: return LIT_TO_STR("<=");
        case TokenType_RightEqual: return LIT_TO_STR(">=");
        case TokenType_Equal: return LIT_TO_STR("=");
        case TokenType_OrEqual: return LIT_TO_STR("|=");
        case TokenType_XorEqual: return LIT_TO_STR("^=");
        case TokenType_AndEqual: return LIT_TO_STR("&=");
        case TokenType_LeftShiftEqual: return LIT_TO_STR("<<=");
        case TokenType_RightShiftEqual: return LIT_TO_STR(">>=");
        case TokenType_PlusEqual: return LIT_TO_STR("+=");
        case TokenType_MinusEqual: return LIT_TO_STR("-=");
        case TokenType_StarEqual: return LIT_TO_STR("*=");
        case TokenType_DivideEqual: return LIT_TO_STR("/=");
        case TokenType_PercentEqual: return LIT_TO_STR("%=");
        case TokenType_EqualEqual: return LIT_TO_STR("==");
        case TokenType_NotEqual: return LIT_TO_STR("!=");
        case TokenType_LogicalAnd: return LIT_TO_STR("&&");
        case TokenType_LogicalOr: return LIT_TO_STR("||");
        ...
        case TokenType_LTick: return LIT_TO_STR("<");
        case TokenType_RTick: return LIT_TO_STR(">");
